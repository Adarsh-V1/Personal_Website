    ...
    (<div className="h-full lg:pt-25 gap-20 flex-col  w-full lg:w-fit flex items-center justify-center invert hue-rotate-180  ">
      <PinContainer title="Visit LinkedIn " href="https://www.linkedin.com/in/adarshpathania04/">
        <div
          ...
          <Image
            src="https://www.jbg.org.uk/wp-content/uploads/2023/09/linkedin3.jpg"
      ...
      <PinContainer title="Visit GitHub" href="https://github.com/Adarsh-V1">
        <div
          ...
          <Image
            src="https://www.legitsecurity.com/hs-fs/hubfs/GithubSecurity.webp?width=2100&height=1200&name=GithubSecurity.webp"
