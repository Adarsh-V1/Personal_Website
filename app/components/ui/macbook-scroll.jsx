...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className=" min-h-[190vh]  flex flex-col items-center py-2 lg:py-48 md:py-10 justify-start shrink-0 [perspective:800px] transform md:scale-100  scale-[0.50] sm:scale-50">
      <motion.h2
        style={{
  ...
  return (
    (<div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#01010187] rounded-2xl p-2">
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <Image
          src={src}
          alt="aceternity logo"
          fill
          className="object-cover object-left-top fixed  rounded-lg inset-0 h-full w-full" />
      </motion.div>
    </div>)
  );
};
...
export const KBtn = ({
  ...
  return (
    (<div
      className={cn(
        "p-[0.5px] rounded-[4px]",
        backlit && "bg-white/[0.2] shadow-xl shadow-fuchsia-100"
      )}>
      <div
        className={cn(
...
export const Row = ({
  ...
  return (<div className="flex gap-[2px] mb-[2px] w-full shrink-0">{children}</div>);
};
